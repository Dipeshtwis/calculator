...
describe('calculator logic', () => {
  ...
  it('When 4 is clicked, and total and operation is not null, next is null, it returns a next = "4"', done => {
  ...
  it('When 5 is clicked, and total, operation and next is not null, it returns a next = "45"', done => {
